            ...
            <div className='w-[100%] mt-20 sm:w-[50%]'>
                ...
                >
                    ...
                    <button id="resume-button-2" onClick={() => window.open(resume, '_blank')}>
                        <a id="resume-link-2" className='group m-1 bg-white dark:bg-white/10 px-10 max-[426px]:px-7 max-[376px]:px-5 py-3 max-[376px]:py-2 rounded-full flex items-center gap-2 focus:scale-105 hover:scale-105 active:scale-100 transition ' download href={resume} target="_blank">Resume <span className='inline-block opacity-60 group-hover:translate-y-1 transition'><HiDownload /></span></a>
                    </button>
