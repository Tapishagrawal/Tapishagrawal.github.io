...
export default function Home() {
    return (
        <div id='home' className='pt-32 w-[90%] m-auto flex flex-col-reverse sm:flex-row justify-between items-center '>
            <div className='w-[100%] mt-20 sm:w-[45%]'>
                ...
                >
                    <a className='m-1 bg-gray-900 hover:bg-gray-800 px-10 max-[426px]:px-7 max-[376px]:px-5 py-3 max-[376px]:py-2 rounded-full text-white flex items-center gap-2 focus:scale-105 hover:scale-105 active:scale-100 transition' href="https://github.com/Tapishagrawal">GitHub <FaGithubSquare /></a>
                    <a className='group m-1 bg-white dark:bg-white/10 px-10 max-[426px]:px-7 max-[376px]:px-5 py-3 max-[376px]:py-2 rounded-full flex items-center gap-2 focus:scale-105 hover:scale-105 active:scale-100 transition ' href="/" target="_blank">Resume <span className='inline-block opacity-60 group-hover:translate-y-1 transition'><HiDownload /></span></a>
            ...
            <motion.div className='w-[45%] relative'>
                <motion.div 
                    ...
                    className='relative w-[350px] max-[640px]:-ml-6 max-[570px]:-ml-12 max-[426px]:w-[270px] max-[426px]:w-[240px] max-[426px]:w-[200px] max-[426px]:-ml-[3.7rem]'
                >
                    ...
                    <motion.span 
                        ...
                        className='absolute bottom-0 right-[7rem] max-[426px]:right-[4rem] text-4xl'
                    >👋</motion.span>
                </motion.div>
            </motion.div>
        </div>
