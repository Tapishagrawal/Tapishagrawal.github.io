...
export const Project = () => {
    ...
    return (
        ...
        >
            <div
                className='bg-gray-100 max-w-[42rem] m-auto border border-black/5 rounded-lg   overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-gray-200 transition'>
                <div className='pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full group-even:ml-[20rem]'>
                    ...
                    <p className='mt-2 leading-relaxed text-gray-700'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit repellat sint aliquam quibusdam nostrum ea?</p>
                ...
                <img src="http://placehold.co/800x600/png" className='absolute top-8 -right-40 w-[25.25rem] rounded-t-lg shadow-2xl transition  
