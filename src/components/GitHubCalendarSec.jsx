...
export const GitHubCalendarSec = () => {
    return (
        <div className="flex flex-col gap-6 px-2">
            ...
            <div id="github-top-langs" className="flex justify-center items-start">
                <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=tapishagrawal&layout=compact" />
            </div>
