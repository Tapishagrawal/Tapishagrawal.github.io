...
export const GitHubCalendarSec = () => {
    return (
        <div className="mt-32">
            <SectionHeading >GitHub Start</SectionHeading>
            <div className="flex flex-col gap-6 px-2 ">
                ...
                <div className="flex justify-center flex-col items-center gap-8 sm:flex-row">
                    ...
                    <div>
                        <img id="github-stats-card" src="https://github-readme-stats.vercel.app/api?username=tapishagrawal&show_icons=true&theme=tokyonight" />
                    </div>
                </div>
            </div>
        </div>
